...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/SuzuhaOtoha/clash/constant.Version=$(VERSION)" \
		-X "github.com/SuzuhaOtoha/clash/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
